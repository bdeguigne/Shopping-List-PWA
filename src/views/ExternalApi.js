    ...
    <>
      <div className="mb-5">
        ...
        <p>
          ...
          of the requests `Authorization` header and the API will validate it
          using the APIs audience value.
        </p>

        {!audience && (
          <Alert color="warning">
            <p>
              You cant call the API at the moment because your application does
